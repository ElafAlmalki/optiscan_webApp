...
Original file is located at
    https://colab.research.google.com/drive/12sKEQ1wtupZfy_eytt3vskxjhpKnh2VL
"""
...
def download_all_models():
    ...
    download_model_from_drive(
        "1CLpud_9yx34Bt2UiAF0tpRZuBJ9g3Oae", "model/type_classifier_model.h5"
    )
    download_model_from_drive(
        "16pwnSHZp3DaO2XZxzpg9DB8pxBU8NUV2", "model/cfp_model.h5"
    )
    download_model_from_drive(
        "1LwQh88Cc-boe6pyEabUkQbDPdoN07Ber", "model/oct_model.h5"
    )

# نبدأ بتحميل الموديلات
download_all_models()
